...
| 94  | Interactive League Dashboard          | 🟡     | P2       | 2      | 17           | Per-team dashboard exists; no league-wide overview yet                                         |
...
- [ ] Play-in + playoff bracket generation from final standings
- [ ] Series simulation (best-of-7, reusing the Phase 1 game engine)
- [ ] Interactive bracket UI
- [ ] League-wide dashboard view (standings + recent results), not just
      the user's own team
