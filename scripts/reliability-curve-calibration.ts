/**
 * Fits `RELIABILITY_CURVE_EXPONENT`. Attempt six.
 *
...
console.log(
  `${"EXP".padStart(7)}${"P1 BUST".padStart(10)}${"P1 -> 80+".padStart(11)}${"YIELD".padStart(8)}` +
    `${"90+".padStart(7)}${"85+".padStart(7)}${"80+".padStart(7)}${"RATIO".padStart(9)}${"ERR".padStart(9)}`,
);

let best = { exponent: 0, err: Infinity };
for (const exponent of [1.0, 1.75, 2.0, 2.25, 2.5, 3.0]) {
